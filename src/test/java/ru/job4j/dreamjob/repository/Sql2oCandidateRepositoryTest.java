...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(
                new Candidate(0, "Иван Иванов", "Описание кандидата", creationDate, 1, file.getId())
        );
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var candidate1 = sql2oCandidateRepository.save(
                new Candidate(0, "Кандидат 1", "Описание 1", creationDate, 1, file.getId())
        );
        var candidate2 = sql2oCandidateRepository.save(
                new Candidate(0, "Кандидат 2", "Описание 2", creationDate, 2, file.getId())
        );
        var candidate3 = sql2oCandidateRepository.save(
                new Candidate(0, "Кандидат 3", "Описание 3", creationDate, 1, file.getId())
        );
    ...
    public void whenUpdateUnExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "Иван Иванов", "Описание кандидата", creationDate, 1, file.getId());
